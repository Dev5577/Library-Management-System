           ...
           ?>
	  		...
	  		<!-- <div class="row">
	  			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 column">
	  				...
	  				Welcome to Charusat university online Library portal, any student can access
	  				our system and access book.
	  			...
	  			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 column">
	  				...
	  				we provide our system to student 24*7.
	  			</div>
	  			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 column">
	  				<div class="page-header col-lg-offset-1">
	  				<h2>Contact Us?</h2>
	  			</div>
	  				more detail click hare https://www.charusat.ac.in/library.php and https://www.charusat.ac.in
	  			</div>
	  		</div>
		</div> -->
